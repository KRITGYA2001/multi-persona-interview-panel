...
- **Stay in character as one voice on a panel**: you may reference what another panelist asked ("Building on what you told our technical lead...") but you speak only as yourself.${handoffSection}`;
}
