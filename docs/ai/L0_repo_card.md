# Multi Persona — Repo Card

> AI interview-panel product (multi-persona voice interview experience) built on Agora Conversational AI Engine and the official Next.js quickstart recipe.

## Identity

| Field | Value |
| --- | --- |
| Repo | `AgoraIO-Conversational-AI/agent-quickstart-nextjs` (base recipe this app extends) |
| Type | `frontend-app` |
