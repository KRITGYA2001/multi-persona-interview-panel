...
| [persona_handoff.md](persona_handoff.md) | Persona switch sequence, fixed-agentUID rationale, context hand-off, and transcript attribution | Changing `PersonaSwitcher`, mid-call persona switching, or hand-off context behavior |
