  ...
  return (
    <div className="relative flex-shrink-0">
      ...
      <div
        ...
        className={`fixed top-16 left-1/2 z-20 w-[min(92vw,22rem)] -translate-x-1/2 rounded-xl border border-border/60 bg-card/90 p-3 space-y-2 shadow-[0_20px_50px_-15px_rgba(74,74,74,0.35)] backdrop-blur-xl transition-opacity md:absolute md:left-0 md:top-full md:mt-3 md:w-[24rem] md:translate-x-0 md:translate-y-0 ${
