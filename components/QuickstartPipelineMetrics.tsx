      ...
      {PIPELINE.map((step, index) => {
        ...
        return (
          <div key={step.key} className="flex items-center gap-2">
            ...
            <span className="rounded-full border border-border/60 bg-card/40 px-2.5 py-0.5 text-xs font-semibold leading-4 text-foreground shadow-sm backdrop-blur-sm">
              {step.label}
              {metric && (
                <span
