    ...
    <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DropdownMenuTrigger asChild>
        <Button
          variant="ghost"
          size="icon"
          className="rounded-full w-10 h-10 bg-secondary/80 backdrop-blur-sm hover:bg-accent/10 border border-border/70 shadow-sm transition-colors"
      ...
      <DropdownMenuContent
        align="center"
        className="w-56 bg-popover/95 border-border/70 backdrop-blur-xl shadow-[0_20px_50px_-15px_rgba(74,74,74,0.35)]"
      >
